<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Control_Calidad_Movil.aspx.cs" Inherits="rinya_app.Calidad.Otros_Controles.Control_Calidad_Movil" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   $("#<%= TextBox_Desde.ClientID %>").datepicker().datepicker("setDate", new Date());
      ...
      <h2>Control Laboratorio Planta</h2>
