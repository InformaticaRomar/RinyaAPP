<% @Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Indicador_Temperaturas.aspx.cs" Inherits="rinya_app.Calidad.Otros_Controles.Indicador_Temperaturas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  if (!($("[id$=datepicker1]").datepicker().attr("Value") == undefined)) {
    ...
    <div class="row">
        <div class="col-md-8">
            <h2>Informe Indicador Temperatura</h2>
