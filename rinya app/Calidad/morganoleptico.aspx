<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="morganoleptico.aspx.cs" Inherits="rinya_app.Calidad.morganoleptico" %>
<!DOCTYPE html>
   ...
   <script type="text/javascript"> 
       ...
       function loadTable() {
          ...
          var table = $('#tblData').DataTable({
               ...
               "bProcessing": true,
               "bServerSide": true,
               "sAjaxSource": "WebService_Organoleptico.asmx/GetTableData2",
               
               "fnServerData": function (sSource, aoData, fnCallback) {
                   aoData.push({ "name": "Matricula", "value":"1" });
          ...
          $("#tblData tbody").on("click", 'tr', function (e) {
              ...
              C_Datos.ID_ESTADO = $(nTds[79]).text();
              ...
              $('#table-dialogo').dialog({
                  ...
                  open: function (event, ui) {
                      if (C_Datos.ARTICULO.length > 0) {
                          ...
                          var estado_com = parseFloat($(nTds[71]).children('#Vmin_chk').val());
                          ...
                          if (Usuario=='1'){
                              ...
                              $('#text_observa_comite').val($(nTds[78]).text());
                              $('#text_H_arriba').val($(nTds[72]).text());
                          
                              var arriba = $(nTds[73]).text();
                              ...
                              $('#text_H_medio').val($(nTds[74]).text());
                          
                              var medio = $(nTds[75]).text();
                              ...
                              $('#text_H_abajo').val($(nTds[76]).text());

                              var abajo = $(nTds[77]).text();
                  ...
                  <td id ="lbl_57" style="width: 250px">Medio </td>
                            ...
                            <td class="cell">
                                <input id="txt_E_medio" type="hidden" style="width: 46px" value="" />
                                   ...
                                   <tr id="Blck_58">   
                  <td id ="lbl_58" style="width: 100px">Bajo </td>
                            <td class="cell">
                            ...
                            <td class="cell">
                                ...
                                <input id="text_E_abajo_A" type="checkbox" onclick="check_Abajo_A();">Incorrecto
                                   ...
                                   <tr id="Blck_59">   
                  <td id ="lbl_59" style="width: 250px">Resultado comité </td>
